...
<body class="fondo">
  ...
  <div class="container p-4">
    <div class="card text-center">
      <div class="card-header">
        ...
        <h3 class="card-title text-uppercase">Jurados registrados</h3>
      </div>
      <div class="card-body">
          ...
          <table class="table table-bordered" width="100%" cellspacing="0">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td> <a class="btn btn-secondary" href="modificarD.php?id=<?php echo $row['id']; ?>&tipo=1">Editar</a>
                </td>
                <td> <a class="btn btn-danger" href="eliminar.php?id=<?php echo $row['id']; ?>&tipo=3">Eliminar</a>
                </td>
              </tr>
              <?php } ?>
            </tbody>
  ...
  <a class="btn btn-success" href="reporteD.php" target="_blank">Reporte de Jurados</a>
</div>
    </div>
  </div>
