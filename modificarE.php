...
<body class="udenar">
  ...
  <div class="container p-4">
    ...
    <div class="card text-center">
      ...
      <div class="card-body">
        <form action="updateE.php?id=<?php echo $Id_Usuario; ?>&tipo=<?php echo $tipo; ?>" method="POST">
          ...
          <div class="form-group row">
            <div class="col-sm-6 mb-3 mb-sm-0">
              <input type="text" name="sede" placeholder="Sede" class="form-control" value="<?php echo $Sede; ?>">
            </div>
            <div class="col-sm-6">
          ...
          <div class="form-group">
            <a class="btn btn-primary btn-block" <?php if($tipo==1) {?>href="listadoE.php"
              <?php }else {?>href="perfilE.php"
              <?php } ?> >Regresar
            </a>
          </div>
      </div>
