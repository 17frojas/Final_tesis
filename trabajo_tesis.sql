...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-10-2022 a las 01:27:34
...
CREATE TABLE `docentes` (
  ...
  `celular` int(10) NOT NULL,
  `rol` enum('Estudiante','Jurado') NOT NULL,
...
--
ALTER TABLE `docentes`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21454771;

--
-- AUTO_INCREMENT de la tabla `estudiantes`
--
ALTER TABLE `estudiantes`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10361;

--
-- AUTO_INCREMENT de la tabla `tesis`
--
ALTER TABLE `tesis`
  MODIFY `numTesis` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
COMMIT;
